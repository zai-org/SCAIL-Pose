...
if __name__ == "__main__":
    ...
    kept_subdirs = ['/workspace/ywh_data/pose_packed_wds_1024_step5/stunt_mb_v2025091601', '/workspace/ywh_data/pose_packed_wds_1024_step5/gymnastics_mb_v2025091601']
    kept_keys = list(get_all_keys(kept_subdirs[0])) + list(get_all_keys(kept_subdirs[1]))
    ...
    for rank, wds_chunk in enumerate(chunks):
        p = Process(target=process_tar, args=(wds_chunk, output_root, rank + 1000, kept_keys))
        p.start()
        processes.append(p)
