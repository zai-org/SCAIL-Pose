...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_root', type=str, default='/workspace/ywh_data/pose_packed_wds_1102finetune_step5_final',
                        help='Output root')
    ...
    kept_subdirs = ['/workspace/ywh_data/pose_packed_wds_1024_step5/recall']
